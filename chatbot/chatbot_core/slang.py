...
SLANG_GROUPS: dict[str, tuple[tuple[str, ...], tuple[str, ...]]] = {
    "meme_fun": (
        ...
        ("把“乐乐/乐子”按网络梗处理，可能是在说好笑、看热闹、找乐子，不要只当普通人名", "优先结合上下文和记忆判断具体含义"),
    ),
    "laugh": (
        ("笑死", "笑鼠", "xswl", "绷不住", "蚌埠住", "绷", "乐", "哈哈", "草", "艹"),
        ("接住笑点，用短句、重复符号或轻微吐槽回应", "可用 6、哈、绷、我靠 这类短反应"),
    ),
    "absurd": (
        ("离谱", "逆天", "抽象", "典", "孝", "急", "赢", "地狱笑话"),
        ("按荒诞/吐槽语境理解", "回答可以更跳一点，但不要解释梗本身"),
    ),
    "done": (
        ("寄", "寄了", "丸辣", "完辣", "完啦", "麻了", "破防", "开摆", "摆烂"),
        ("按崩溃、放弃、被打击的情绪理解", "可短促共情，也可顺势吐槽"),
    ),
    "true_or_fake": (
        ("尊嘟假嘟", "真的假的", "真嘟假嘟", "真假的", "真的假的啊"),
        ("按怀疑/震惊语气理解", "可用 啊？、真的假的、什么 这类追问"),
    ),
    "thanks": (
        ("栓q", "栓Q", "3q", "thank you", "谢谢", "谢了"),
        ("按轻松感谢语境理解", "可以简短回应，不要过度正式"),
    ),
    "knowledge": (
        ("芝士", "知识", "涨姿势", "姿势", "懂了", "学到了"),
        ("把谐音当成知识/信息增量", "可以用短确认或继续补一句"),
    ),
    "sad": (
        ("蓝瘦香菇", "难受想哭", "难受", "想哭", "emo", "玉玉", "抑郁"),
        ("按低落语境理解", "更像朋友聊天，轻一点安抚"),
    ),
    "surprise": (
        ("我超", "卧槽", "我靠", "woc", "wc", "卧艹", "好家伙", "啊？"),
        ("按震惊/情绪上扬理解", "可用短句和连续标点模拟反应"),
    ),
    "game": (
        ("原神", "ys", "崩铁", "星铁", "sr", "zzz", "绝区零", "鸣潮", "mc", "米哈游", "米"),
        ("优先按游戏/二游上下文召回记忆", "回答可以带一点玩家式吐槽"),
    ),
    "relationship": (
        ("cp", "嗑", "磕", "kswl", "好嗑", "官配", "拉郎", "磕死我了"),
        ("按 CP/关系梗理解", "可以轻微起哄或追问细节"),
    ),
}
